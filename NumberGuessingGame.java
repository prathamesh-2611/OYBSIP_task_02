...
class Game{
    ...
    public boolean takeUserInput(){
        if(noOfGuesses < 10){
            ...
            System.out.println("Number of attempts finished.... Better lick next time");
            return true;
        }
    }
    ...
    public boolean isCorrectGuess(){
        if(systemInput == userInput){
            System.out.println("Congratulations you guessed the correct number " + systemInput + " in " + noOfGuesses + " guesses");
            switch (noOfGuesses){
                case 1:
        ...
        if(choice == 1){
            ...
            while(nextRound == 1){
                ...
                while(!isMatched && !isLimitCrossed){
                    isLimitCrossed = game.takeUserInput();
